...
ESLint is a powerful tool for identifying and reporting patterns in ECMAScript/JavaScript code. In many ways, it is similar to JSLint and JSHint with a few exceptions:
